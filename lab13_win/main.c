...
int main(void)
{
    ...
    _Bool replaced = replace(addresses, "Babak", "new_babak@sce.carleton.ca"); 
    printf("Replace Babak: %s\n", replaced ? "Success" : "Failure"); 
    printf("Email for Babak is now %s\n", get(addresses, "Babak"));  
    replaced = replace(addresses, "NonExistentKey", "some_value"); 
    printf("Replace NonExistentKey: %s\n", replaced ? "Success" : "Failure"); 
    printf("Printing dictionary contents:\n"); 
    print_dictionary(addresses);

    printf("Testing clear function:\n");  
    clear(addresses); 
    printf("Dictionary after clear:\n"); 
    print_dictionary(addresses);
